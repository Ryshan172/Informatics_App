...
public class PowerDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWasteStorageRef = FirebaseStorage.getInstance().getReference("powerdata");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mWasteUploadTask != null && mWasteUploadTask.isInProgress()){
                    Toast.makeText(PowerDataActivity.this, "Upload in Progress", Toast.LENGTH_SHORT).show();
                }
                else {
                    wasteuploadFile();
                }
            ...
            mWasteUploadTask = foodfileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(PowerDataActivity.this, "Upload successful", Toast.LENGTH_LONG).show();
                            ...
                            Intent intent = new Intent(PowerDataActivity.this, PowerManagement.class);
                            startActivity(intent);
                            ////
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(PowerDataActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
