...
public class HydroDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hydro_data);
        ...
        mWasteStorageRef = FirebaseStorage.getInstance().getReference("hydrodata");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mWasteUploadTask != null && mWasteUploadTask.isInProgress()){
                    Toast.makeText(HydroDataActivity.this, "Upload in Progress", Toast.LENGTH_SHORT).show();
                }
                else {
                    wasteuploadFile();
                }
            ...
            mWasteUploadTask = foodfileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(HydroDataActivity.this, "Upload successful", Toast.LENGTH_LONG).show();
                            ...
                            Intent intent = new Intent(HydroDataActivity.this, HydroManagement.class);
                            startActivity(intent);
                            ////
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(HydroDataActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
